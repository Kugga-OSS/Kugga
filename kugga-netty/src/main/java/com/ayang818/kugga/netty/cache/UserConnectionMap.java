...
public class UserConnectionMap {
     ...
     */
    private static final Map<Long, Set<Connection>> MAP = new ConcurrentHashMap<>();

    public static void put(Long userId, String channelShortId) {
    ...
    public static Set<Connection> get(Long userId) {
